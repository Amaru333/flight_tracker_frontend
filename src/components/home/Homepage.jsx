  ...
  return (
    <div>
      ...
      <div className="relative">
        <img src="/cover.png" className="w-full max-h-[550px] object-cover hidden sm:block" />
        <div className="absolute top-0 left-0 w-full">
          <div className="max-w-screen-2xl m-auto px-0 sm:px-8">
            <div>
              <img src="/logo.png" className="w-60 cursor-pointer" />
            </div>
            <div className="px-4 py-16 shadow-lg sm:bg-white-900 sm:bg-clip-padding sm:backdrop-filter sm:backdrop-blur-3xl bg-opacity-100 rounded-lg mt-0 sm:mt-72">
              <div className="flex-row justify-between grid grid-cols-1 sm:grid-cols-3 gap-5">
